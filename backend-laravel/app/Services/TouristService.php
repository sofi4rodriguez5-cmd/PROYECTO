...
class TouristService
{
    ...
    // Lugares Turísticos
    public function getAllTouristPlaces(): Collection
    {
    ...
    {
        return $this->touristPlaces->firstWhere('id', $id);
    }
    
    public function getTouristPlacesByCategory(string $category): Collection
    {
        return $this->touristPlaces->filter(function($place) use ($category) {
    ...
    {
        return $this->touristPlaces->pluck('category')->unique()->values()->toArray();
    }
    ...
    {
        return $this->hotels->firstWhere('id', $id);
    }
    ...
    {
        return $this->restaurants->firstWhere('id', $id);
    }
    
    public function getRestaurantsByCuisine(string $cuisineType): Collection
    {
        return $this->restaurants->filter(function($restaurant) use ($cuisineType) {
    ...
    {
        return $this->restaurants->pluck('cuisineType')->unique()->values()->toArray();
    }
    
    // Transporte
    public function getAllTransportations(): Collection
    {
    ...
    {
        return $this->transportations->firstWhere('id', $id);
    }
    
    public function getTransportationsByType(string $type): Collection
    {
        return $this->transportations->filter(function($transportation) use ($type) {
    ...
    {
        return $this->transportations->pluck('type')->unique()->values()->toArray();
    }
    ...
    private function initializeTouristPlaces(): Collection
    {
        $places = [];
    ...
    private function initializeHotels(): Collection
    {
        $hotels = [];
    ...
    private function initializeRestaurants(): Collection
    {
        $restaurants = [];
    ...
    private function initializeTransportations(): Collection
    {
        $transportations = [];
        ...
        return collect($transportations);
    }
